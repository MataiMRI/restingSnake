...
for i in range(len(df)):
    ...
    print('\n\n', confounds, '\n')
    confounds.to_csv(func_path + 'regressors.txt', header=True, index=None, sep="\t")
...
if len(check) > 0:
    print('\nMEAN FRAMEWISE DISPLACEMENT EXCEEDS', displacement_threshold, 'MILLIMETRES! THE FILES BELOW REQUIRE THE USERS ATTENTION AND WILL NOT PROCEED TO FIRST LEVEL ANALYSIS! See workflow_record.csv')
